...
import { errorHandler,notFound } from "./middlewares/errorMiddleware.js"; // 👉 3.4 and 5.3
import logger from "./middlewares/logger.js"; //5.3
...
app.use(logger); // 👉 ধাপ ৫,3: logger middleware
...
app.use(notFound); // 👉 ধাপ ৫: 404 handler
